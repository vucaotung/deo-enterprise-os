...
4. A14.9 — build a real media bridge for Aurora so Telegram/Zalo inbound bill images can reach the OCR pipeline directly; current state still relies on Dẹo for image bills and Aurora for text/PDF.
